...
const Conserto = sequelize.define('Conserto', {
  numeroOS: { type: DataTypes.INTEGER, allowNull: false },
  protocolo: { type: DataTypes.STRING, allowNull: true },
  nomeCliente: { type: DataTypes.STRING, allowNull: false },
  telefoneCliente: { type: DataTypes.STRING, allowNull: true },
  equipamentoUtilizado: { type: DataTypes.STRING, allowNull: false },
  descricaoProblema: { type: DataTypes.TEXT, allowNull: false },
